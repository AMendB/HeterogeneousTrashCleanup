...
class EGreedyAgent:
    def __init__(self, env, rw_fn, rw_weights) -> None:
        ...
        if self.reward_function == 'Influence_area_changes_model':
            from Environment.CleanupEnvironment import get_reward_influence_area_changes_model as get_reward
        elif self.reward_function == 'Position_changes_model':
            from Environment.CleanupEnvironment import get_reward_position_changes_model as get_reward
        elif self.reward_function == 'Error_with_model':
            from Environment.CleanupEnvironment import get_reward_error_with_model as get_reward
